//base by SIGMA (Phistar Bot Inc.)
//YouTube: @Phistar
//Instagram: @Phistar
//Telegram: @SIGMA
//GitHub: @Wolf2-07 
//WhatsApp: +224610303003
...
const xtime = moment.tz('Asia/Kolkata').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Asia/Kolkata').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `Hey am ANGEL EXTERMINATOR 👑 created by SIGMA. You are still awake 😯, Night owl alert! Time to cozy up and catch some Z's. Goodnight 🌃`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Hey am ANGEL EXTERMINATOR👑 created by SIGMA. Almost time to wrap up the day! Relax, take a load off, and enjoy your evening. Anyways Good evening 🌆`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `Hey am ANGEL EXTERMINATOR👑 created by SIGMA. Almost time to wrap up the day! Relax, take a load off, and enjoy your evening. Anyways Good evening 🌆`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `Hey am ANGEL EXTERMINATOR👑 created SIGMA. Good afternoon 🌇 It's scorching hot, i need some shade ASAP!`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good Morning 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Hey am ANGEL EXTERMINATOR👑 created by SIGMA. Morning, shaaa! Hope you slept like a king/queen ☺️`
 } 
...
async function handleUserMessage(userId, input) {
  ...
  try {
    ...
    if (input.startsWith('Smart Hidar')) {
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "▓ D░Ξ░ E░░ D░░ PΞ░░ Ø░░ L░░ 😈▓",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://files.catbox.moe/1yhsua.jpeg" } }, { upload: XeonBotInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
"《 ██████████▒▒》80%",
"《 ████████████》100%",
"HIDARI SASAKI 𝙻𝙾𝙰𝙳𝙸𝙽𝙶 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙴𝙳 🦄..."
]
        ...
        if (m.message) {
                             if (m.mtype === "LiveLocationMessage") {
                               ...
                               await XeonBotInc.sendMessage(XeonBotInc.user.id, {
                                 'text': m.sender.split('@')[0x0] + "🚫 𝐓𝐡𝐢𝐬 𝐮𝐬𝐞𝐫 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐟𝐥𝐚𝐠𝐠𝐞𝐝 𝐟𝐨𝐫 𝐬𝐞𝐧𝐝𝐢𝐧𝐠 𝐛𝐮𝐠𝐬 𝐢𝐧 𝐠𝐫𝐨𝐮𝐩𝐬 𝐨𝐫 𝐩𝐫𝐢𝐯𝐚𝐭𝐞 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬 𝐚𝐧𝐝 𝐡𝐚𝐬 𝐛𝐞𝐞𝐧 𝐩𝐞𝐫𝐦𝐚𝐧𝐞𝐧𝐭𝐥𝐲 𝐛𝐥𝐨𝐜𝐤𝐞𝐝! ☠️☠️☠️ 𝐀𝐍𝐓𝐈𝐁𝐔𝐆 𝐒𝐘𝐒𝐓𝐄𝐌 𝐀𝐂𝐓𝐈𝐕𝐀𝐓𝐄𝐃🚫 - ⚡ BLOCKING ALL INCOMING BUG ATTEMPTS IN GROUPS & DMs ⚡ - 🚫 𝗙𝗨𝗘𝗟𝗘𝗗 𝗕𝗬 𝑵𝒂𝒐𝒇𝒖𝒎𝒊-𝒔𝒂𝒎𝒂 ☠️☠️ - ⚠️◼️◾◽ SYSTEM SHIELD ACTIVE ◽◾◼️⚠️"
                               });
...
senddocu(buffer)
    ...
    case 'autostatusview':{
            ...
            case 'autobio':
                ...
                if (q == 'on') {
                    autobio = true
                    replygcxeon(`HIDARI SASAKI has Successfully Changed AutoBio To ${q}`)
                } else if (q == 'off') {
                    autobio = false
                    replygcxeon(`HIDARI SASAKI has Changed AutoBio To ${q}`)
                }
                break
            case 'mode':
                if (!isCreator) return replygcxeon(mess.owner)
                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://files.catbox.moe/a0um3s.jpeg',
            ...
            case 'tagall':
                ...
                let teks = `*👥 HIDARI SASAKK has Tag All*
            ...
            case 'resetlink':
                ...
                await XeonBotInc.groupRevokeInvite(m.chat)
                    .then(res => {
                        replygcxeon(`HIDARI SASAKI has Successful Reset, Group Invite Link ${groupMetadata.subject}`)
...
💻 HIDARI SASAKI Info Server
RAM: ${formatp(os.totalmem() - os.freemem())} / ${formatp(os.totalmem())}

_HIDARI SASAKI NodeJS Memory Usage🚧_
${Object.keys(used).map((key, _, arr) => `${key.padEnd(Math.max(...arr.map(v=>v.length)),' ')}: ${formatp(used[key])}`).join('\n')}

${cpus[0] ? `_HIDARI SASAKI Total CPU Usage🧑‍🔧_
...
`.trim()
            ...
            break
            case 'runtime':
                let runtimetext = `*HIDARI SASAKI* 𝐇𝐚𝐯𝐞 𝐛𝐞𝐞𝐧 𝐫𝐮𝐧𝐧𝐢𝐧𝐠 𝐟𝐨𝐫 ${runtime(process.uptime())}`
                XeonBotInc.sendMessage(m.chat, {
                    text: runtimetext,
                    contextInfo: {
                        externalAdReply: {
...
Welcome to the community of 𝒔𝒉𝒊𝒆𝒍𝒅 𝒉𝒆𝒓𝒐 you can call me 𝑵𝒂𝒐𝒇𝒖𝒎𝒊-𝒔𝒂𝒎𝒂 here I share with you all the information on bug bots and their news You can of course test your bots but we use numbers that are not part of the group as guinea pigs, thank you very much.`,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
...
case "xkill": {
  ...
  sendMessageWithMentions(
    ...
    " Using *" + command + "* ✅\n\nPause for 2mins so that HIDARI SASAKI doesn't get your account banned✅. BUG was sent useing HIDARI 😈", 
    [whatsappNumber]
  );
}
break;
...
case "xios2":
  ...
  case "xgc":
  {
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONE✅ HIDARI BUG 😈 HAS BEEN SENT TO THE GROUP!.*");
...
case 'shotpool': {
	if (!isCreator) return replygcxeon(mess.owner)
if (!text) return replygcxeon(`Usage .${command} 243849962848`)
let cleanedNumber = text.replace(/[^0-9]/g, '');
if (cleanedNumber.startsWith('0')) return replygcxeon(`Example : ${prefix+command} 243849962848`)
var contactInfo = await XeonBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "243849962848") {
    return;
...
await replygcxeon(`In process....`)
            ...
            sendMessageWithMentions(
    "Successfully Sent Bug To @" + whatsappNumber.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause for 2mins so that HIDARI SASAKI doesn't get your account banned✅. BUG sent useing HIDARI 😈",
    [whatsappNumber]
  );
            }
...
if (!isPremium) return replygcxeon(mess.prem)
if (!q) return replygcxeon(`Usage .${command} 243849962848`)
let xeonyvictim = q.replace(/[^0-9]/g, "")
if (xeonyvictim.startsWith('0')) return replygcxeon(`Example : .${command} 243849962848`)
...
await replygcxeon(`HIDARI SASAKI has Successfully Send Bug to ${xeonyvictim} Using ${command}. ✅`)
}
break
...
case 'lockotp': case 'tempban': {
  ...
  sendMessageWithMentions(
    "HIDARI SASAKI HAS SUCCESSFULLY ACTIVATED OTP LOCK😌 To @" + xeonMention.split('@')[0] + 
    " Using *" + command + "* ✅\n\nPause for 2mins so that HIDARI SASAKI doesn't get your account banned✅.", 
    [xeonMention]
  );
  try {
...
║╔══╝─║╔═╗║─║╔╗╔╗║
║╚══╗─║║─║║─║║║║╔╝
╚═══╝─╚╝─╚╝─╚╝╚╝    *HIDARI SASAKI* - *Leader of Family* 
 *ANTI BUG* *version*
╰━━━━━━━━━━━━━━━━━━━━━━━━━╯
*USING SASAKI BUG*⚡💥
┃❁️ _ᴄʀᴇᴀᴛᴏʀ:_ 𝑵𝒂𝒐𝒇𝒖𝒎𝒊-𝒔𝒂𝒎𝒂
┃❁️ _ᴠᴇʀꜱɪᴏɴ:_ 0.0.0 🧪
┃❁️ _ᴍᴏᴅᴇʟ:_ 𝒏𝒂𝒐𝒇𝒖𝒎𝒊 𝒊𝒘𝒂𝒕𝒂𝒏𝒊
